...
window.VerseOfDay = (() => {
  ...
  const DAILY_PASSAGES = [
    ...
    { primary: "ROM.12.4-ROM.12.5", fallbacks: ["PSA.46.1"] },    //JAN 3
    ...
    { primary: "ISA.40.31", fallbacks: ["GAL.13.14"] },           //JAN 11
    ...
    // February
    { primary: "ROM.5.3-ROM.5.4", fallbacks: ["PSA.46.1"] },      //FEB 1
    { primary: "MAT.7.3", fallbacks: ["PSA.51.10"] },             //FEB 2
    { primary: "ROM.8.28", fallbacks: ["PSA.91.2"] },             //FEB 3
    { primary: "PRO.3.5-PRO.3.6", fallbacks: ["1JN.4.19"] },      //FEB 4
